...
namespace Const_Log
{
    ...
    namespace Message
    {
        ...
        const QString LastKnownLocation_BEGIN = "LastKnownLocation BEGIN" + NewLine;
        const QString LastKnownLocation_END = "LastKnownLocation END" + NewLine;
        const QString LastKnownLocation_INLINE = "LastKnownLocation INLINE" + NewLine;
        const QString LastKnownLocation_LOCK = "LastKnownLocation LOCK" + NewLine;
        const QString LastKnownLocation_UNLOCK = "LastKnownLocation UNLOCK" + NewLine;
