...
Enable clangd in Qt Creator `Tools\Options\C++\clangd`,  
Qt Creator will generate `compile_commands.json`,  
finally, create symbolic link to source root use `create_symbolic_link.bat`.
